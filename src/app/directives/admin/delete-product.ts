...
declare var $: any;
//kalsın ama delete-directive-module ile düzeltildi gerek kalmadı
@Directive({
  selector: '[appProductDelete]', // Selector değişti
  standalone: false
})
export class ProductDeleteDirective extends Base { // Class adı değişti
        ...
        if (result === DeleteState.Yes) {
          ...
          this.httpClientService.delete({
            ...
            next: (data) => {
              ...
              $(td.parentElement).animate({
                ...
                this.customToastr.message(
                  "Ürün başarıyla silinmiştir", // Product mesajı
                  "Başarılı",
                  {
            ...
            error: (httpErrorResponse: HttpErrorResponse) => {
              this.hideSpinner(SpinnerType.BallAtom);
              this.customToastr.message(
                "Ürün silinirken bir hata oldu", // Product mesajı
                "Başarısız",
                {
