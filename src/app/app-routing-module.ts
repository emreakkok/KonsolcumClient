...
const routes: Routes = [
  {path : "admin",component: Layout, children:
    [
      ...
      {path:"myOrders", loadChildren : ()=> import("./admin/components/my-order/my-order-module").then
      (module => module.MyOrderModule), canActivate: [authGuard]},
  ...
  {path:"categories", loadChildren: () => import("./ui/components/categories/categories-module").then
  (module => module.CategoriesModule)},
  {path:"categories/:pageNo", loadChildren: () => import("./ui/components/categories/categories-module").then
  (module => module.CategoriesModule)},
  {
  path: "categories/:categoryId/products/:pageNo",
  loadChildren: () => import("./ui/components/categories/categories-module").then(module => module.CategoriesModule)
  },
  {
